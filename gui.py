...
class TravelportGUI:
    ...
    def _open_time_calculator(self):
        ...
        # ── outer layout: scroll-proof wrapper ───────────────────────────────
        outer = tk.Frame(dlg, bg="#f2f2f2")
        ...
        def _make_panel(parent, title, col):
            ...
            for r, (lbl, default) in enumerate(rows):
                ...
                e.grid(row=r, column=1, sticky="w", padx=(6, 0), pady=3)

            sep = ttk.Separator(frm, orient="horizontal")
            sep.grid(row=len(rows), column=0, columnspan=2, sticky="ew", pady=(10, 6))
        ...
        _make_panel(outer, "Flight 1", 0)
        _make_panel(outer, "Flight 2", 1)

        outer.columnconfigure(0, weight=1, uniform="panel")
        outer.columnconfigure(1, weight=1, uniform="panel")
